...
HD_PWD='D:/project/DPU_Project_vivado/DPU_vivado/DPU_vivado.runs/DPU_dpu_conv_top_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DPU_dpu_conv_top_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DPU_dpu_conv_top_0_0.tcl
