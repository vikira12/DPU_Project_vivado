...
HD_PWD='D:/project/DPU_Project_vivado/DPU_vivado/DPU_vivado.runs/DPU_rst_ps7_0_50M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DPU_rst_ps7_0_50M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DPU_rst_ps7_0_50M_0.tcl
