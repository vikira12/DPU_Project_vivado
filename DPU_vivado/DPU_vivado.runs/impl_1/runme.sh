...
HD_PWD='D:/project/DPU_Project_vivado/DPU_vivado/DPU_vivado.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DPU_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DPU_wrapper.tcl -notrace
