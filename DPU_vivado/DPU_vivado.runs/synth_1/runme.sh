...
HD_PWD='D:/project/DPU_Project_vivado/DPU_vivado/DPU_vivado.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DPU_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DPU_wrapper.tcl
