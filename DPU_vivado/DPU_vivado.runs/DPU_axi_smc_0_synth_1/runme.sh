...
HD_PWD='D:/project/DPU_Project_vivado/DPU_vivado/DPU_vivado.runs/DPU_axi_smc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DPU_axi_smc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DPU_axi_smc_0.tcl
